...
@define ('STORAGE', '{{ db_engine }}'); # postgres, mysql or sqlite
...
{% if db %}
@define ('STORAGE_SERVER', '{{ db.host() }}');
@define ('STORAGE_DB', '{{ db.database() }}');
@define ('STORAGE_USER', '{{ db.user() }}');
@define ('STORAGE_PASSWORD', '{{ db.password() }}');
{% endif %}
